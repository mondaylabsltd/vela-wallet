...
const SCENARIOS: {
  ...
  },
  {
    ...
    request: {
      ...
      method: 'eth_sendTransaction',
      params: [{
        to: '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D', // Uniswap V2 Router (no ERC-7730 descriptor)
        // swapExactTokensForTokens(1000 USDC, ≥0.5 WETH, [USDC,WETH], to, deadline)
        // No descriptor → recovered + decoded via the 4-byte selector fallback.
        data: '',
        value: '0x0',
      }],
      origin: 'clear-signing-test',
    },
