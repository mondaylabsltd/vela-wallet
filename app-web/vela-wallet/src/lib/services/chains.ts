...
export const CHAINS: ChainMeta[] = [
	...
	// The eleven admitted together (spec 061), in the core's order. Stable's native
	// coin is USDT0 — the core pegs it and refuses its ERC-20 mirror, exactly as Arc.
	{
		id: 'xlayer',
		displayName: 'X Layer',
		chainId: 196,
		apiNetworkId: 'xlayer-mainnet',
		nativeSymbol: 'OKB',
		iconLabel: 'OKB',
		iconColor: '#000000',
		iconBg: '#ECECEC',
	...
	},
	{
		...
		chainId: 4663,
		apiNetworkId: 'robinhood-mainnet',
		nativeSymbol: 'ETH',
		iconLabel: 'RH',
		iconColor: '#00C805',
		iconBg: '#E3F8E5',
