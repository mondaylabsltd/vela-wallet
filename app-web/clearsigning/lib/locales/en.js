...
window.VelaCS.i18n.register('en', {
  ...
  'value.viaTunnel': 'your wallet on another device · through the tunnel',
  ...
  'ui.tunnelConnecting': 'Connecting to the tunnel…',
  'ui.tunnelWaiting': 'Waiting for the wallet to join this link…',
  'ui.tunnelConfirm': 'Check that your wallet shows the same code, and confirm it there.',
  'ui.tunnelLeft': 'The wallet dropped out of the connection. Waiting for it to come back…',
  'ui.tunnelForeign': 'The device that answered is not the wallet that made this link. Nothing was sent to it, and this page has disconnected.',
  'ui.tunnelExpired': 'This link has expired. Start again from the wallet.',
  'ui.tunnelTaken': 'Another page is already answering this link.',
  'ui.tunnelBadLink': 'This pairing link is not valid.',
  'ui.tunnelClosed': 'The tunnel closed the connection.',
  ...
  'ui.tunnelJoined': 'The wallet is here. Securing the connection…',
});
