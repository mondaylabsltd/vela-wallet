...
const ns = loadPageLibs(['lib/keccak.js', 'lib/abi.js', 'lib/encode.js', 'lib/signer.js', 'lib/ceremony.js',
  'lib/transport/secure.js']);
...
try {
  ...
  // === D. the relay ============================================================
  {
    ...
    await page.waitFor("window.__velaState.phase === 'waiting'");
    const verify = wallet.request('rv1', { method: 'vela_proof', params: [{ credentialId, purpose: 'verify' }], origin: '' }, {});
