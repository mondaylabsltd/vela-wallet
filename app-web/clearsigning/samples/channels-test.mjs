...
try {
  ...
  // drove (`ClearSignerWs`) — the phones reach that code through UniFFI, not
  // wasm. It is tested where it runs: Android's `ClearSignerChannelTest` and
  // `ClearSignerCeremonyTest`, against the same core.
  //
