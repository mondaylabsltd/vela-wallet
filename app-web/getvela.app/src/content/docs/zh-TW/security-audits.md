...
這些不是合約層面的發現，而是錢包對你的保護不如你可能以為的那麼多的地方。除了註明是刻意取捨的項目，
每一項都已列入待修：

- **無上限授權只要你保留，就會送出**——這是刻意的取捨，因為設了上限的授權會讓 Permit2 和批次兌換無法正常運作。
  「無上限」授權（2^200 以上；Permit2 則是 2^152）會以紅色顯示，除非你設定上限，否則會照 dApp 要求的原樣送出。
  在網頁版和桌面版上，批次交易裡的授權還不能設定上限；簽章式授權則在任何地方都無法設定上限。
- **獨立簽署頁還沒有接到**任何應用程式。
