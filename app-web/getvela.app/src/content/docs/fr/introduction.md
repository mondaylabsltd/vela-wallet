...
Vela est un **portefeuille en auto-conservation pour Ethereum et les autres réseaux
EVM**, sans phrase de récupération. Votre portefeuille est un compte intelligent
[Safe](/fr/docs/account-contract) non modifié, et vous signez avec des **passkeys** —
sur votre téléphone ou votre ordinateur, sur un autre téléphone, ou sur une clé de
sécurité matérielle.
...
- **Fonctionne sans nous.** Les apps et les services sont open source et
  remplaçables — avec les limites détaillées dans le
