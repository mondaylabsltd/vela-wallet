...
Una carpeta —`app-web/trusted-signer` en el repositorio— que es a la vez página web y
...
2. **Cargar extensión sin empaquetar** y elige la carpeta `app-web/trusted-signer`.
