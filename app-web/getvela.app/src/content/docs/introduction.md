...
Vela is a **self-custodial wallet for Ethereum and other EVM networks** with no seed
phrase. Your wallet is an unmodified [Safe](/docs/account-contract) smart account,
and you sign with **passkeys** — on your phone or computer, on another phone, or
...
- **Runs without us.** The apps and services are open source and replaceable —
  with the limits spelled out in the [self-hosting guide](/docs/self-hosting).
