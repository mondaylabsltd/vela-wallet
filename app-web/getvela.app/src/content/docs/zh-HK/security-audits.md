...
這些不是合約層面的發現，而是錢包對你的保護不及你可能以為的地方。除註明屬刻意取捨的項目外，每一項都已
記錄在案，有待修正：

- **無限授權只要你保留，便會發出**——這是刻意的取捨，因為設有上限的授權會令 Permit2 和批量兌換無法正常
  運作。「無限」授權（2^200 或以上；Permit2 為 2^152）會以紅色顯示，除非你設定上限，否則會按 dApp 要求的
  原樣發出。在網頁版和桌面版上，批量交易中的授權暫時未能設定上限；簽名式授權則在任何地方都無法設定上限。
- **獨立簽名頁尚未接入**任何 App。
