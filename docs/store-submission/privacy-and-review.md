...
| **Wallet address**                                                       | Yes (in queries / signed tx)    | Third-party RPC nodes, Vela Bundler                    | No — on-chain pseudonymous           | Read balances, submit transactions      | Required (functional)                   |
