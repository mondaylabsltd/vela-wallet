...
fn def(icon: PasskeyIcon) -> IconDef {
    match icon {
        PasskeyIcon::Apple => IconDef {
            ...
            view: 16.,
            elements: &[
            (Role::Ink, "<path d=\"M13.625 5.775c-.066.04-1.625.862-1.625 2.687.074 2.08 1.967 2.81 2 2.81-.033.04-.286.995-1.037 1.996-.595.862-1.256 1.732-2.26 1.732-.956 0-1.299-.575-2.4-.575-1.184 0-1.519.575-2.425.575-1.004 0-1.714-.916-2.343-1.77-.816-1.119-1.51-2.873-1.534-4.558-.016-.893.163-1.771.62-2.516.645-1.041 1.796-1.748 3.053-1.771.963-.03 1.82.629 2.408.629.563 0 1.616-.629 2.808-.629.514 0 1.885.148 2.735 1.39zM8 4.207c-.172-.816.301-1.631.742-2.151C9.306 1.426 10.196 1 10.963 1a2.952 2.952 0 0 1-.816 2.197c-.498.63-1.355 1.103-2.146 1.01z\" fill=\"{}\"/>"),
            ],
        },
        PasskeyIcon::Windows => IconDef {
            ...
            view: 16.,
            elements: &[
            (Role::Ink, "<path d=\"M14 7.6H8.4V2H14v5.6zm-6.4 0V2H2v5.6h5.6zM2 8.4h5.6V14H2V8.4zm6.4 0V14H14V8.4H8.4z\" fill-rule=\"evenodd\" clip-rule=\"evenodd\" fill=\"{}\"/>"),
            ],
        },
        PasskeyIcon::Google => IconDef {
            ...
            view: 16.,
            elements: &[
            (Role::Ink, "<path d=\"M15 6.545h-3.818v1.91H15v-1.91zM4.5 11A3.51 3.51 0 0 1 1 7.5 3.51 3.51 0 0 1 4.5 4 3.51 3.51 0 0 1 8 7.5 3.51 3.51 0 0 1 4.5 11zm0-5.09c-.875 0-1.59.715-1.59 1.59 0 .875.715 1.59 1.59 1.59.875 0 1.59-.715 1.59-1.59 0-.875-.715-1.59-1.59-1.59z\" fill=\"{}\"/>"),
            (Role::Ink, "<path d=\"M11.182 8.455v1.909h1.272v-.637c0-.35.287-.636.637-.636.35 0 .636.286.636.636v.637H15v-1.91h-3.818zM7.873 6.545h-2.1c.19.27.318.59.318.955 0 .366-.127.684-.318.955h2.1c.08-.303.127-.62.127-.955 0-.334-.048-.652-.127-.955z\" fill=\"{}\"/>"),
            (Role::Ink, "<path d=\"M11.182 6.545h-3.31c.08.303.128.62.128.955 0 .334-.048.652-.127.955h3.309v-1.91z\" fill=\"{}\"/>"),
            ],
        },
        ...
        PasskeyIcon::Fido2 => IconDef {
            ...
            view: 16.,
            elements: &[
            (Role::Ink, "<path d=\"M8 6.667A1.333 1.333 0 1 0 8 4a1.333 1.333 0 0 0 0 2.667z\" fill=\"{}\"/>"),
            (Role::Ink, "<path d=\"M8 1.333c-2.207 0-4 1.794-4 4v5.334C4 11.4 4.6 12 5.333 12H6v1.333c0 .734.6 1.334 1.333 1.334h1.334c.733 0 1.333-.6 1.333-1.334V12h.667C11.4 12 12 11.4 12 10.667V5.333c0-2.206-1.793-4-4-4zm2.667 9.334H5.333V5.333a2.666 2.666 0 1 1 5.334 0v5.334z\" fill=\"{}\"/>"),
            ],
        },
        PasskeyIcon::Usb => IconDef {
            ...
            view: 80.,
            elements: &[
            (Role::Ink, "<path d=\"M33 11C33 9.89543 33.8954 9 35 9H47C48.1046 9 49 9.89543 49 11V25H33V11Z\" fill=\"{}\"/>"),
            (Role::Paper, "<rect x=\"35\" y=\"11\" width=\"2\" height=\"12\" fill=\"{}\"/>"),
            (Role::Paper, "<rect x=\"40\" y=\"11\" width=\"2\" height=\"12\" fill=\"{}\"/>"),
            (Role::Paper, "<rect x=\"45\" y=\"11\" width=\"2\" height=\"12\" fill=\"{}\"/>"),
            (Role::Muted, "<path d=\"M31.7686 23H50.2272C51.2135 23 52.0737 23.7553 52.3154 24.8335C54.1052 32.8185 55.0001 40.7432 55.0001 48.6075C55.0001 56.5746 53.5305 64.5403 50.5915 72.5044C50.2573 73.41 49.4728 74 48.6029 74H33.3977C32.5275 74 31.7429 73.4096 31.4089 72.5036C28.4697 64.5306 27.0001 56.5398 27.0001 48.531C27.0001 40.6305 27.8939 32.7296 29.6816 24.8282C29.9249 23.7526 30.7841 23 31.7686 23Z\" fill=\"{}\"/>"),
            (Role::Ink, "<path d=\"M41.0001 54C44.8661 54 48.0001 50.866 48.0001 47C48.0001 43.134 44.8661 40 41.0001 40C37.1341 40 34.0001 43.134 34.0001 47C34.0001 50.866 37.1341 54 41.0001 54Z\" fill=\"{}\"/>"),
            (Role::Paper, "<path d=\"M41.0001 68C43.2092 68 45.0001 66.2091 45.0001 64C45.0001 61.7909 43.2092 60 41.0001 60C38.7909 60 37.0001 61.7909 37.0001 64C37.0001 66.2091 38.7909 68 41.0001 68Z\" fill=\"{}\"/>"),
            ],
        },
    }
}
...
impl PasskeyIconCache {
    ...
    pub fn image(&mut self, icon: PasskeyIcon, palette: Palette, logical_px: u32) -> Arc<RenderImage> {
        let size = logical_px * crate::icons::RASTER_SCALE;
        let key = (icon, hex(palette.ink).1, hex(palette.muted).1, hex(palette.paper).1, size);
...
mod tests {
    ...
    fn every_mark_is_the_contract() {
        ...
        for icon in [
            ...
            assert_eq!(spec["viewBox"][0].as_f64().unwrap() as f32, d.view, "{}", d.id);
