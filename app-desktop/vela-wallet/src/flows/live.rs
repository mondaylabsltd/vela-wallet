...
use crate::flows::fixtures::{
    ...
    FeeSpeedOption, FeeTokenPick, FeeTokenRow, FilterChip, HistoryGroup, NetworkRow, ReceiveGate,
    ReceiveList, ReceiveQr, RecipientCard, SendConfirm, SendForm, SendNotice, SendPick,
    SendReceipt, StatusChip, StatusTone, TokenMark, address_lines,
};
