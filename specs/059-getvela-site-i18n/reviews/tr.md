...
The sixteen docs are not translated into `tr` yet; they render English under a
...
market's own product copy uses (formal, `siz`).
...
speaker of Turkish has read it. That is the whole distinction between `drafted`
and `reviewed` here.
