...
The sixteen docs were translated into `vi` afterwards (T056/T057, 2026-09-16)
...
market's own product copy uses (neutral `bạn`).
...
speaker of Vietnamese has read it. That is the whole distinction between `drafted`
and `reviewed` here.
