...
//!
//! The Clear Signer's whole claim is **you see what you sign**, and that rests
...
//!
//! [`BUILD_ALLOWED`] is empty, because no page has been published under
//! `/b/<sha256>/` yet (076 phase B). An empty set means [`decide`] opens
//! nothing on the official address — so wiring this into the launch path
//! before phase B would brick a Clear Signer that works today. Phase B
//! publishes the page and fills the set; phase C does the wiring.
