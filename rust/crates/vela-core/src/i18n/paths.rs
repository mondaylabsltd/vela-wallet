...
//!
//! 1633 paths = 1548 leaf + 85 branch. Repeated per locale these key bytes
//! would cost 644250 bytes; interned once they cost 44486.
...
pub(crate) static PATHS: [&str; 1633] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 205] = [
    ...
    0x00, 0x98, 0x04, 0x08, 0x10, 0x02, 0x24, 0x44, 0x80, 0x40, 0x10, 0x10, 0x00, 0x00, 0x00, 0x86,
    0x00, 0x00, 0x00, 0x02, 0x40, 0x04, 0x20, 0x00, 0x81, 0x00, 0x82, 0x00, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1633;
