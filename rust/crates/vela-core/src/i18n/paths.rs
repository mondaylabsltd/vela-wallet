...
//!
//! 1692 paths = 1604 leaf + 88 branch. Repeated per locale these key bytes
//! would cost 666285 bytes; interned once they cost 46012.
...
pub(crate) static PATHS: [&str; 1692] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 212] = [
    ...
    0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00,
    ...
    0x08, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00, 0x00, 0x01, 0x02, 0x40, 0x04, 0x20, 0x00, 0x01, 0x08,
    0x04, 0x10, 0x04, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1692;
