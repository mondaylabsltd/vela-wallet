...
//!
//! 1673 paths = 1586 leaf + 87 branch. Repeated per locale these key bytes
//! would cost 660315 bytes; interned once they cost 45597.
...
pub(crate) static PATHS: [&str; 1673] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 210] = [
    ...
    0x00, 0x00, 0x00, 0x80, 0x49, 0x80, 0x00, 0x21, 0x40, 0x42, 0x04, 0x08, 0x04, 0x01, 0x01, 0x00,
    0x00, 0x60, 0x08, 0x00, 0x00, 0x20, 0x40, 0x00, 0x88, 0x00, 0x04, 0x20, 0x00, 0x81, 0x00, 0x82,
    0x00, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1673;
