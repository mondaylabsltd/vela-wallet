...
//!
//! 1742 paths = 1653 leaf + 89 branch. Repeated per locale these key bytes
//! would cost 692535 bytes; interned once they cost 47778.
...
pub(crate) static PATHS: [&str; 1742] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 218] = [
    ...
    0x80, 0x00, 0x10, 0x02, 0x00, 0xe0, 0x24, 0x49, 0x42, 0x00, 0x08, 0x00, 0x80, 0x00, 0x00, 0x00,
    0x00, 0x80, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x04,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4c, 0x02, 0x10, 0x20, 0x04, 0x48, 0x42,
    0x04, 0x08, 0x04, 0x01, 0x01, 0x00, 0x02, 0x00, 0x00, 0xc0, 0x10, 0x00, 0x00, 0x40, 0x80, 0x00,
    0x00, 0x11, 0x80, 0x00, 0x04, 0x20, 0x10, 0x40, 0x10, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1742;
