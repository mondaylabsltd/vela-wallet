...
export class FeeTierPrefCore {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FeeTierPrefCoreFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_feetierprefcore_free(ptr, 0);
    }
    /**
     * @param {string} event_json
     * @returns {string}
    ...
    dispatch(event_json) {
        ...
        try {
            const ptr0 = passStringToWasm0(event_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.feetierprefcore_dispatch(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    constructor() {
        const ret = wasm.feetierprefcore_new();
        this.__wbg_ptr = ret;
        FeeTierPrefCoreFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {bigint} effect_id
    ...
    resolve_effect(effect_id, result_json) {
        ...
        try {
            const ptr0 = passStringToWasm0(result_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.feetierprefcore_resolve_effect(this.__wbg_ptr, effect_id, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    view() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.feetierprefcore_view(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
if (Symbol.dispose) FeeTierPrefCore.prototype[Symbol.dispose] = FeeTierPrefCore.prototype.free;
 ...
 * @returns {string}
 */
export function feeSpeedRule(request_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(request_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.feeSpeedRule(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
